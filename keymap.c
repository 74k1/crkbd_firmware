...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //.-----------------------------------------------------.                    .-----------------------------------------------------.
    //| TAB    | Q      | W      | E      | R      | T      |                    | F1     | F2     | F3     | F4     | §      | ESC    |
         KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                         KC_4,    KC_3,    KC_2,    KC_1, CH_SECT,  KC_ESC,
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
    //| LSFT   | A      | S      | D      | F      | G      |                    | H      | J      | K      | L      | /      | RSFT   |
        KC_LSFT,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L, CH_SLSH, KC_RSFT,
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
    //| LCTL   | Y      | X      | C      | V      | B      |                    | N      | M      | ,      | .      | -      | LAYER5 |
        KC_LCTL,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, CH_COMM,  CH_DOT, CH_MINS,   TG(5),
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                        //| MOD    | LAYER6 | SPACE  |  |        |        |        |
                                            KC_LGUI,   MO(6),  KC_SPC,    XXXXXXX, XXXXXXX, XXXXXXX
                                        //'--------+--------+--------'  '--------+--------+--------'
    ),
    [6] = LAYOUT_split_3x6_3( // GAMING LAYER 2
    //.-----------------------------------------------------.                    .-----------------------------------------------------.
    ...
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
    //| LCTL   | Y      | X      | C      | V      | B      |                    | N      | M      | ,      | .      | -      | LAYER5 |
        KC_LCTL,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      _______, _______, _______, _______, _______,   TG(5),
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                        //| MOD    | LAYER6 | SPACE  |  |        |        |        |
